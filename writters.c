...
void* reader(void* arg) {
    while (1) {
        ...
        usleep(500000); // Pausa de 0,5 segundos (500 milissegundos)
        ...
        usleep(5000000); // Pausa de 0,5 segundos (500 milissegundos)
    }
    return NULL;
}
...
void* writer(void* arg) {
    while (1) {
        ...
        usleep(1000000); // Pausa de 1 segundo (1000 milissegundos)
